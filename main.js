document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', async (e) => {
            // Let it submit via Formspree but handle success UI nicely
            // If they submit via fetch, we can show a success message
    ...
    function getResponse(text) {
        ...
        const hasAll = (keywords) => keywords.every(keyword => normalizedText.includes(keyword));
        ...
        if (hasPhrase(['who are you', 'what is your name', 'your name', 'who is srushti', 'tell me about srushti', 'tell me about her', 'introduce yourself', 'about srushti', 'about her', 'overview', 'background', 'who she is'])) {
        ...
        if (hasAny(['project', 'projects', 'work', 'built', 'build', 'portfolio', 'created', 'developed', 'made', 'app', 'application'])) {
        ...
        if (hasAny(['skill', 'skills', 'tech', 'technology', 'stack', 'language', 'programming', 'coding', 'code', 'framework', 'tools'])) {
        ...
        if (hasAny(['education', 'college', 'study', 'student', 'degree', 'university', 'nxtwave', 'engineering', 'cgpa', 'course', 'studying'])) {
        ...
        if (hasAny(['contact', 'email', 'phone', 'reach', 'connect', 'linkedin', 'github', 'social', 'message'])) {
        ...
        if (hasAny(['achievement', 'achievements', 'award', 'awards', 'hackathon', 'winner', 'finalist', 'rank', 'top', 'recognized', 'recognition'])) {
        ...
        if (hasAny(['lead', 'leadership', 'oscode', 'role', 'team', 'appointed', 'technical team lead', 'mentor'])) {
        ...
        if (hasAny(['location', 'from', 'city', 'home', 'hubli', 'karnataka', 'where is she'])) {
            return `Srushti is based in <strong>Hubli, Karnataka</strong>.`;
        }

        if (hasAny(['interest', 'interests', 'passion', 'goal', 'aspiration', 'future', 'wants', 'likes'])) {
            return `She is passionate about full-stack development, machine learning, AI, and creating solutions that make a real impact.`;
        }

        if (hasAny(['why', 'what makes', 'strength', 'good at', 'can do', 'best', 'special'])) {
        ...
        if (hasAll(['what', 'does'])) {
            return `She works on technology, projects, and learning experiences focused on software development and AI.`;
        }
